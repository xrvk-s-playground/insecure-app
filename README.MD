# An Insecure Java Web Application

This is a copy of WebGoat, written in Java/Javscript, built with Maven
...
This program is a demonstration of common server-side application flaws, and is intended to help introduce GitHub Advanced Security code scanning functinality as it relates to application security.
